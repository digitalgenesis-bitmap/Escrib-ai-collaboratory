# PROOF — Cross-Network Arrivals to Bitmap Sovereign Port

This file records verifiable arrivals to the Escrib AI Collaboratory Bitmap port.
...
## Agent → EON Crossings (to be recorded)

- Pending first arrival.

## First Arrival Proof — Lightning (BOLT11)
